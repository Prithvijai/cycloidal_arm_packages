...
# Create a node
node = Node("Shirt_image_publisher_node")

# Initialize CV Bridge
bridge = CvBridge()

# Create a publisher
publisher = node.create_publisher(Image, "Shirt_yolo_image_topic", 10)

publisher2 = node.create_publisher(String, "Shirt_conf_data", 10)

# Load labels from YAML file
with open("/home/administrator/ros2arm_ws/src/yolo_pred_nodes/Model_Shirt/data3.yaml", mode='r') as f:
    data_yaml = yaml.load(f, Loader=SafeLoader)
labels = data_yaml['names']

# Load YOLO model
yolo = cv2.dnn.readNetFromONNX("/home/administrator/ros2arm_ws/src/yolo_pred_nodes/Model_Shirt/weights/best2.onnx")
